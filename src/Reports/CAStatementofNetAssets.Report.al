...
/// </summary>
report 51005 CAStatementOfNetAssets
{
    AccessByPermission = TableData "G/L Account" = R;
    ApplicationArea = Basic, Suite;
    Caption = 'Statement of Net Assets';
    ProcessingOnly = true;
    ...
    begin
        ...
        GLAccountCategoryMgt.RunAccountScheduleReport(GeneralLedgerSetup."Statement of Net Assets Report");
    end;
}