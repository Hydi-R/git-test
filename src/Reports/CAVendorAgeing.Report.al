...
/// </summary>
report 51000 CAVendorAgeing
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/CAVendorAgeing.Layout.rdl';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            column(Aged_Accounts_Payable_; 'Vendor Ageing')
            {
            }
            ...
            dataitem(Vendor; Vendor)
            {
                ...
                dataitem(Totals; "Integer")
                {
                    ...
                    begin
                        ...
                        j := GetAgingBucket(AgingDate, PeriodEndingDate[1]);
                ...
                begin
                    ...
                    ColumnHead[2] := Days31To60Lbl;
                    ColumnHead[3] := Days61To90Lbl;
                    ColumnHead[4] := Over90DaysLbl;
    ...
    begin
        PrintDetail := true;
        PrintAmountsInLocal := true;
        AgingMethod := AgingMethod::"Due Date";
        UseExternalDocNo := true;
    end;
    //<< Deloitte AK 20082026
    ...
    var
        ...
        // ReportTotalAmountLbl: Label 'Report Total Amount Due (%1)', Comment = '%1=currency code'; // Deloitte AK 20082026
        ReportTotalAmountLbl: Label 'Total of all vendors', Comment = '%1=currency code';
        DataLbl: Label 'Data';
        AgedAccountsPayableLbl: Label 'Vendor Ageing'; // Deloitte AK 20082026
        ...
        NameCaptionLbl: Label 'Vendor Name'; // Deloitte AK 20082026
        AmountDueToPrint_Control74CaptionLbl: Label 'Trans Ref'; // Deloitte AK 20082026
        ...
        Total_Amount_DueCaption_Control86Lbl: Label 'Total'; // Deloitte AK 20082026
        GrandBalanceDue: array[4] of Decimal;
        GrandTotalBalanceDue: Decimal;
        TotalNumberOfEntries: Integer;

        //>> Deloitte AK 04092026
        Days31To60Lbl: Label '31-60 Days';
        Days61To90Lbl: Label '61-90 Days';
        Over90DaysLbl: Label 'Over 90 Days';
    //<< Deloitte AK 04092026
    ...
    // Deloitte AK 04092026++
    local procedure GetAgingBucket(AgingDate: Date; AgingAsOfDate: Date): Integer
    var
        DaysOverdue: Integer;
    begin
        DaysOverdue := AgingAsOfDate - AgingDate;
