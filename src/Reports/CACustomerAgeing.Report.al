...
report 51002 CACustomerAgeing
{
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layouts/CACustomerAgeing.Layout.rdl';
    ...
    var
        ...
        ReportTotalAmountDueLbl: Label 'Total of all customers'; // Deloitte AK 20082026
        DataLbl: Label 'Data';
        AgedAccountsReceivableLbl: Label 'Customer Ageing'; // Deloitte AK 20082026
        ...
        Aged_Accounts_ReceivableCaptionLbl: Label 'Customer Ageing'; // Deloitte AK 20082026
        ...
        BalanceDueLbl: Label 'Balance Receivable'; // Deloitte AK 20082026

        Credit_LimitCaptionLbl: Label 'Credit Limit';
        NameCaptionLbl: Label 'Customer Name'; // Deloitte AK 20082026
